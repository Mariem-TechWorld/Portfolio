...
const ToggleButton = ({ onClick, isShowingMore }) => (
  <button
    onClick={onClick}
    className="px-3 py-1.5 text-slate-300 hover:text-white text-sm font-medium font-mono transition-all duration-300 ease-in-out flex items-center gap-2 bg-white/5 hover:bg-cyan-500/10 rounded-md border border-white/10 hover:border-cyan-500/30 backdrop-blur-sm group relative overflow-hidden"
  >
...
const techStacks = [
  ...
  { icon: "gitlab.svg", language: "GitLab CI" },
  ...
  { icon: "argocd.svg", language: "ArgoCD" },
]
...
export default function FullWidthTabs() {
  ...
  return (
    <div className="md:px-[10%] px-[5%] w-full sm:mt-0 mt-[3rem] bg-[#020818] overflow-hidden" id="Portofolio">
      ...
      <div className="text-center pb-10" data-aos="fade-up" data-aos-duration="1000">
        ...
        <p className="text-slate-400 max-w-2xl mx-auto text-sm md:text-base mt-2 font-mono">
          Cloud infrastructure projects, certifications, and technical expertise.
          Each section represents a milestone in my engineering journey.
        </p>
      </div>
        ...
        <AppBar
          ...
          sx={{
            ...
            "&::before": {
              ...
              background: "linear-gradient(180deg, rgba(6, 182, 212, 0.03) 0%, rgba(99, 102, 241, 0.03) 100%)",
