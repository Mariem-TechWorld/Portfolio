...
const Comment = memo(({ comment, formatDate, index, isPinned = false }) => (
    <div
        className={`px-4 pt-4 pb-2 rounded-xl border transition-all group hover:shadow-lg hover:-translate-y-0.5 ${
            isPinned
                ? 'bg-gradient-to-r from-cyan-500/10 to-indigo-500/10 border-cyan-500/30 hover:from-cyan-500/15 hover:to-indigo-500/15'
    ...
    >
        {isPinned && (
            <div className="flex items-center gap-2 mb-3 text-cyan-400">
                ...
                <span className="text-xs font-medium uppercase tracking-wide font-mono">Pinned Comment</span>
            </div>
        )}
    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
                ...
                className="relative w-full h-12 bg-gradient-to-r from-[#06b6d4] to-[#6366f1] rounded-xl font-medium text-white overflow-hidden group transition-all duration-300 hover:scale-[1.02] hover:shadow-lg active:scale-[0.98] disabled:opacity-50 disabled:hover:scale-100 disabled:cursor-not-allowed"
            >
    ...
    return (
        <div className="w-full bg-gradient-to-b from-white/10 to-white/5 rounded-2xl backdrop-blur-xl shadow-xl" data-aos="fade-up" data-aos-duration="1000">
            ...
            <style jsx>{`
                ...
                .custom-scrollbar::-webkit-scrollbar-thumb { background: rgba(6,182,212,0.5); border-radius: 6px; }
